<template>
  <el-dialog
    ...
    <el-form-item label="" prop="creationTime">
      <el-input v-model="dataForm.creationTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="lastAccessTime">
      <el-input v-model="dataForm.lastAccessTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="maxInactiveInterval">
      <el-input v-model="dataForm.maxInactiveInterval" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="expiryTime">
      <el-input v-model="dataForm.expiryTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="principalName">
      <el-input v-model="dataForm.principalName" placeholder=""></el-input>
    </el-form-item>
    </el-form>
