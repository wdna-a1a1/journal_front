  ...
  >
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px" @keyup.enter.native="dataFormSubmit()">
      <el-form-item label="" prop="nurseLevelId">
        <el-input v-model="dataForm.nurseLevelId" placeholder="" />
      </el-form-item>
      <el-form-item label="" prop="nurseContentId">
        <el-input v-model="dataForm.nurseContentId" placeholder="" />
      </el-form-item>
      <el-form-item label="0-已删除 1未删除" prop="isDeleted">
        <el-input v-model="dataForm.isDeleted" placeholder="0-已删除 1未删除" />
      </el-form-item>
    </el-form>
