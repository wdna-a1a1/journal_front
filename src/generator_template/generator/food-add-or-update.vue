<template>
  <el-dialog
    ...
    <el-form-item label="类别" prop="foodtype">
      <el-input v-model="dataForm.foodtype" placeholder="类别"></el-input>
    </el-form-item>
    <el-form-item label="食品标签" prop="foodlabel">
      <el-input v-model="dataForm.foodlabel" placeholder="食品标签"></el-input>
    </el-form-item>
    ...
    <el-form-item label="是否清真 1-是 0-否" prop="isMuslim">
      <el-input v-model="dataForm.isMuslim" placeholder="是否清真 1-是 0-否"></el-input>
    </el-form-item>
    <el-form-item label="供应星期" prop="supplyDate">
      <el-input v-model="dataForm.supplyDate" placeholder="供应星期"></el-input>
    </el-form-item>
    <el-form-item label="供应类型 1：早餐；2午餐；3晚餐" prop="supplyType">
      <el-input v-model="dataForm.supplyType" placeholder="供应类型 1：早餐；2午餐；3晚餐"></el-input>
    </el-form-item>
    <el-form-item label="图片地址" prop="foodpic">
      <el-input v-model="dataForm.foodpic" placeholder="图片地址"></el-input>
    </el-form-item>
    </el-form>
