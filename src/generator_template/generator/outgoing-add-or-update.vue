<template>
  <el-dialog
    ...
    <el-form-item label="" prop="outgoingReason">
      <el-input v-model="dataForm.outgoingReason" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="outgoingTime">
      <el-input v-model="dataForm.outgoingTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="expectedReturnTime">
      <el-input v-model="dataForm.expectedReturnTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="actualReturnTime">
      <el-input v-model="dataForm.actualReturnTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="escorted">
      <el-input v-model="dataForm.escorted" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="relation">
      <el-input v-model="dataForm.relation" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="escortedTel">
      <el-input v-model="dataForm.escortedTel" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="auditStatus">
      <el-input v-model="dataForm.auditStatus" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="auditPerson">
      <el-input v-model="dataForm.auditPerson" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="auditTine">
      <el-input v-model="dataForm.auditTine" placeholder=""></el-input>
    </el-form-item>
    </el-form>
