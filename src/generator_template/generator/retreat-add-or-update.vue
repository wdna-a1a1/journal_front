<template>
  <el-dialog
    ...
    <el-form-item label="" prop="retreatTime">
      <el-input v-model="dataForm.retreatTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="retreatType">
      <el-input v-model="dataForm.retreatType" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="retreatReason">
      <el-input v-model="dataForm.retreatReason" placeholder=""></el-input>
    </el-form-item>
