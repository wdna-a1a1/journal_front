  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="" prop="customerAge">
        <el-input v-model="dataForm.customerAge" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="" prop="customerSex">
        <el-input v-model="dataForm.customerSex" placeholder=""></el-input>
      </el-form-item>
      ...
      <el-form-item label="" prop="buildingId">
        <el-input v-model="dataForm.buildingId" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="" prop="recordId">
        <el-input v-model="dataForm.recordId" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="活力老人" prop="elderType">
        <el-input v-model="dataForm.elderType" placeholder="活力老人"></el-input>
      </el-form-item>
      <el-form-item label="" prop="checkinDate">
        <el-input v-model="dataForm.checkinDate" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="" prop="expirationDate">
        <el-input v-model="dataForm.expirationDate" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="" prop="contactTel">
        <el-input v-model="dataForm.contactTel" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="" prop="bedId">
        <el-input v-model="dataForm.bedId" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="精神状况" prop="psychosomaticState">
        <el-input v-model="dataForm.psychosomaticState" placeholder="精神状况"></el-input>
      </el-form-item>
      ...
      <el-form-item label="" prop="height">
        <el-input v-model="dataForm.height" placeholder=""></el-input>
      </el-form-item>
      ...
      <el-form-item label="" prop="bloodType">
        <el-input v-model="dataForm.bloodType" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="" prop="filepath">
        <el-input v-model="dataForm.filepath" placeholder=""></el-input>
      </el-form-item>
    </el-form>
  ...
  methods: {
    init(id) {
      ...
      this.$nextTick(() => {
        ...
        if (this.dataForm.id) {
          this.$axios.post(`/generator/customer/info/${this.dataForm.id}`, {}).then(({data}) => {
            if (data && data.code === 0) {
    ...
    dataFormSubmit() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.$axios.post(`/customer/${!this.dataForm.id ? 'save' : 'update'}`,
            this.$qs.stringify({
