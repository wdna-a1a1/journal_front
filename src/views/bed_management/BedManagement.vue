  ...
  <div class="main">
    <div class="left">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-form-item>
          <el-input class="el-input-short" v-model="dataForm.buildingId" placeholder="输入楼房编号" clearable></el-input>
          <el-input class="el-input-short" v-model="dataForm.roomNumber" placeholder="输入房间号" clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <transfer v-if="transferVisible" ref="Transfer" @refreshDataList="getDataList"></transfer>
  </div>
</template>
